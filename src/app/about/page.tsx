    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
      ...
      <div className="text-center space-y-4 max-w-3xl mx-auto">
        ...
        <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
          EthioHome was founded to bring world-class trust, verified infrastructure guarantees, and modern fintech payments to the Ethiopian housing and travel marketplace.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="p-8 rounded-3xl border border-border/70 bg-card space-y-3">
          ...
          <p className="text-xs text-muted-foreground leading-relaxed">
            Every property listed on EthioHome undergoes physical verification of standby generators, water reserve tanks, and compound security.
          </p>
        </div>
