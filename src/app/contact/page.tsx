  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-12">
      <div className="text-center space-y-3">
        ...
        <h1 className="text-4xl font-extrabold text-foreground tracking-tight">Contact EthioHome</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="p-6 rounded-3xl border border-border/70 bg-card text-center space-y-2">
          <Phone className="w-6 h-6 text-green-500 mx-auto" />
        ...
        <div className="p-6 rounded-3xl border border-border/70 bg-card text-center space-y-2">
          <Mail className="w-6 h-6 text-green-500 mx-auto" />
          <h3 className="font-bold text-sm text-foreground">Email Support</h3>
          <p className="text-xs text-muted-foreground">support@ethiohome.et</p>
        </div>

        <div className="p-6 rounded-3xl border border-border/70 bg-card text-center space-y-2">
          <MapPin className="w-6 h-6 text-green-500 mx-auto" />
