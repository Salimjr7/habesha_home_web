    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-8">
      ...
      <div className="p-8 sm:p-10 rounded-3xl border border-border/80 bg-card space-y-6 text-xs sm:text-sm text-muted-foreground leading-relaxed">
        ...
        <section className="space-y-2">
          ...
          <p>
            Payment transactions are processed through regulated Ethiopian payment providers (Chapa, Ethio Telecom telebirr). EthioHome does not store full credit card numbers or banking passwords on our servers.
          </p>
        </section>
