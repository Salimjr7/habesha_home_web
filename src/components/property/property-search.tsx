...
export function PropertySearch() {
  ...
  return (
    <form
      ...
      className="w-full max-w-4xl mx-auto rounded-3xl border border-border/80 bg-card/95 p-3 shadow-2xl shadow-primary/10 backdrop-blur-xl transition-all"
    >
      <div className="grid grid-cols-1 md:grid-cols-4 gap-2 md:gap-0 divide-y md:divide-y-0 md:divide-x divide-border/60">
        {/* Where Input */}
        <div className="p-3 px-4 flex flex-col justify-center rounded-2xl hover:bg-secondary/40 transition-colors">
        ...
        <div className="p-3 px-4 flex items-center justify-between gap-3 rounded-2xl hover:bg-secondary/40 transition-colors">
